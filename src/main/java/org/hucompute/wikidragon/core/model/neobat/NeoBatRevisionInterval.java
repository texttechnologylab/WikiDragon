 ...
 */
public class NeoBatRevisionInterval implements RevisionInterval {
    ...
    protected NeoBatRevisionInterval(NeoBatWikiDragonDatabase pWikiDragonDatabase, String pStartRevisionID, String pEndRevisionID) {
